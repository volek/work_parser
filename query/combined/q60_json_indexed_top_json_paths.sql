...
-- Модель стратегии: горячие поля в основной записи + индексируемые переменные; часть значений может храниться как JSON в process_variables_indexed.
...
-- 1) Выбор источника данных: process_variables_indexed.
